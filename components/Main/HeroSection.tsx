...
export const HeroSection = () => {
  ...
  return (
    <section
      id="inicio"
      ref={heroRef}
      className="relative flex flex-col items-center justify-center text-white bg-black overflow-hidden"
      style={{ height: "100vh", marginTop: "0" }} // Ocupa toda la altura de la ventana
    >
      <div
        ...
        <div className="flex flex-col md:flex-row md:space-x-6 md:space-y-0 space-y-4 items-center">
          <div className="flex items-center space-x-4">
            ...
            <p className="text-lg md:text-xl lg:text-2xl animate-fadeInUp">
              Congreso de Tucuman 786, Concepción del Uruguay
            </p>
          </div>
          <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <p className="text-lg md:text-xl lg:text-2xl animate-fadeInUp">
              Horario: Todos los dias, 18:00 - 23:00
            </p>
          </div>
        </div>
      </div>
